...
const serviceVisualEffects: Record<string, ServiceVisualEffect> = {
  ...
  "Bridal Look Trial": { hairStyle: "Bridal Bun", makeup: "Bridal", accessory: "None" },
  "Wedding Day Signature": { hairStyle: "Bridal Bun", makeup: "Bridal", accessory: "None" },
  "Wedding Guest Radiance": { hairStyle: "Soft Curls", makeup: "Soft Glam", accessory: "Pearl Pins" },
  "Signature Saree Draping": { accessory: "None" },
